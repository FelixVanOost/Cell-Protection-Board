...
The Cell Protection Boards are designed to be modular - they can be modified to accomodate more or fewer batteries with a varying number of cells. Their functionality is also very generic, enabling them to be used with almost any BMS solution or lithium-ion cell chemistry. Mounting holes are placed throughout the board to allow vertical stacking using standoffs.
